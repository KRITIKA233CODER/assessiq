...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — AssessIQ" },
      { name: "description", content: "Sign in or create your AssessIQ educator account." },
    ],
  }),
  component: AuthPage,
});
...
const testimonials = [
  {
    quote: "AssessIQ cut my weekly assessment prep from 6 hours to 20 minutes.",
    author: "Priya S.",
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative overflow-hidden">
        <div className="lg:hidden absolute top-6 left-6 flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-brand text-white flex items-center justify-center font-bold">A</div>
