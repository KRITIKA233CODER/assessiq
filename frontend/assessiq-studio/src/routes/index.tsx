...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "AssessIQ — Create Perfect Exam Papers in Seconds" },
      {
        name: "description",
        content:
          "AssessIQ helps teachers instantly generate structured, curriculum-aligned assessments, quizzes, and assignments using advanced AI.",
      },
    ],
  }),
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between px-5 sm:px-8 h-16">
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight">AssessIQ</span>
        </a>
  ...
  return (
    <section className="relative pt-36 pb-24 px-5 sm:px-8">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Empower your teaching with AssessIQ. Instantly generate structured,
    ...
    <div className="grid grid-cols-12 min-h-[460px] bg-background">
      <div className="hidden md:flex col-span-3 lg:col-span-2 flex-col gap-3 bg-card border-r border-border p-5">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-brand text-white flex items-center justify-center font-bold">A</div>
    ...
    <section id="features" className="py-24 px-5 sm:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto">
          <div className="text-xs font-semibold uppercase tracking-widest text-brand">Why AssessIQ</div>
  ...
  const steps = [
    {
      ...
      desc: "Drop your syllabus PDF, paste topic notes, or simply describe what you need. AssessIQ listens and learns.",
      icon: Upload,
    ...
    },
    {
      ...
      desc: "Watch as AssessIQ structures a perfectly balanced paper — difficulty, marks, and types tuned to your class.",
      icon: Wand2,
  ...
  const reviews = [
    {
      ...
      quote:
        "AssessIQ cut my weekend planning time in half. The quality of the physics questions it generates is indistinguishable from my own.",
    },
    {
      name: "Arjun Mehta",
    ...
    },
    {
      ...
      quote:
        "Our entire science department uses AssessIQ now. The PDF export looks better than what we made in Word.",
    },
    {
      name: "Rohan Iyer",
    ...
    <footer className="border-t border-border bg-card">
      ...
      <div className="border-t border-border">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} AssessIQ. All rights reserved.</p>
