...
export const Route = createFileRoute("/onboarding")({
  head: () => ({
    meta: [
      { title: "Set up your workspace — AssessIQ" },
      { name: "description", content: "Complete your AssessIQ educator profile." },
    ],
  }),
...
function StepIdentity({
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mt-1">This helps us tailor AssessIQ to your role.</p>
