...
export const Route = createFileRoute("/view/$id")({
  head: () => ({ meta: [{ title: "Question Paper — AssessIQ" }] }),
  component: ViewPage,
});
      ...
      case "uploading":
        return (
          <div className="flex flex-col items-center justify-center p-8 bg-card rounded-3xl shadow-card space-y-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">Uploading references to AssessIQ repository.</p>
          </div>
        );
      ...
      case "pending":
        return (
          <div className="flex flex-col items-center justify-center p-8 bg-card rounded-3xl shadow-card space-y-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">Waiting for AssessIQ engine instance to spawn...</p>
          </div>
        );
      ...
      case "processing":
        return (
          <div className="flex flex-col items-center justify-center p-8 bg-card rounded-3xl shadow-card space-y-4 text-center">
            ...
            <h3 className="font-bold text-lg">AssessIQ is writing your exam...</h3>
            ...
            <div className="bg-card rounded-3xl p-6 sm:p-10 shadow-card">
              <div className="text-center border-b border-border pb-6">
                <h2 className="text-xl sm:text-2xl font-bold tracking-tight">
                  {paperData.institutionName || "AssessIQ Academy"}
                </h2>
